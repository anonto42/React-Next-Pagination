...
const Tabale = ({ rows , colums , heading , rowHeight = 52 }) => {
  return (
    <Container sx={{height:"100vh"}}>
        <Paper elevation={3} sx={{padding:"1rem 4rem",borderRadius:'1rem',margin:"auto",width:"100%",overflow:"hidden",height:"100%",boxShadow:"none"}}>
            ...
            <DataGrid rows={rows} columns={colums} rowHeight={rowHeight} style={{height:"80%"}} sx={{border:"none",".table-header":{bgcolor:"black",color:"white"}}}/>
        </Paper>
    </Container>
  )
}
